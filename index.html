...
<head>
  ...
  <title>PYAE THUTA | Portfolio</title>
  
  <link rel="shortcut icon" type="image/x-icon" href="assets/img/pyaethuta.jpg">
...
<body class="theme-red">
  ...
  <div class="topbar-nav fixed-top">
    ...
    <h3 class="ml-1" style="font-size: 20px;"><span style="color: #1affff;">PYAE</span> THUTA</h3>
  ...
  <div class="vg-main-wrapper">
    ...
    <div class="vg-page page-home" id="home" style="background-image: url('assets/img/banner-img.jpg');">
      <div class="caption wow zoomInUp">
        <h1 class="fw-normal" style="color:white;text-shadow: 0px 0px 10px #00e6e6;">Hi. I'm PYAE THUTA</h1><br>
        <h2 class="fw-medium" id="" style="color:white;">I'm a <span class="typed-text"></span> <span class="cursor">&nbsp;</span></h2>
        <a class="tagline" href="#about">About Me <span class="icon ti-user"></span></a>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="img-place wow zoomIn">
              <img src="assets/img/pyaethuta.jpg" alt="Photo Profile">
            </div>
          </div>
          <div class="col-md-6">
            <div class="caption wow fadeInRight">
              ...
              <a class="btn btn-theme btn-rounded" href="PYAE THUTA_CV_2022.pdf">Download CV</a>
            </div>
          </div>
        </div>
      </div> <!-- End profile -->
      ...
      <div class="container mt-5" id="skills">
        ...
        <div class="row py-3">
          ...
          <div class="col-md-6">
            ...
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">Content Management</span>
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 90%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">90%</div>
              </div>
            </div><br>
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">Network and hardware knowledge</span>
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 88%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">88%</div>
              </div>
            </div><br>
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">Office Technology</span>
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 95%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">95%</div>
              </div>
            </div><br>
        ...
        <div class="row">
          <div class="col-md-6 wow fadeInRight">
            ...
            <ul class="timeline mt-4 pr-md-5">
              ...
              <li>
                <div class="title">2021 - current</div>
                <div class="details">
                  <h5>BSc (Hons) COMPUTING (Ongoing)</h5>
                  <small style="color:#00b3b3;">University of Greenwich</small>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="details">
                  <h5>Level 5 Diploma in Computing</h5>
                  <small style="color:#00b3b3;">NCC Education, KMD Institute</small>
                  <p>Achieved a distinction mark of 79% in qualification</p>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="details">
                  <h5>Level 4 Diploma in Computing</h5>
                  <small style="color:#00b3b3;">NCC Education, KMD Institute</small>
                  <p>Achieved a distinction mark of 72% in qualification</p>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="details">
                  <h5>English Language course</h5>
                  <small style="color:#00b3b3;">Yangon University of Foreign Language </small>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="details">
                  <h5>Matriculated</h5>
                  <small style="color:#00b3b3;">B.E.H.S (1), Thingangyun, Yangon</small>
                  <p>Matriculated in 2017-2018 acedemic year </p>
                </div>
              </li>
...
<!--     <div class="vg-page page-contact" id="contact">
      ...
      <div class="container mt-5" id="contact">
        ...
        <ul class="theme-list"><br>
                <li class="fg-dark"><b>Address :</b> Thingangyun, Yangon, Myanmar</li><br>
                <li class="fg-dark"><b>Email   :</b><a href="mailto:pyaethuta881@gmail.com" class="call">pyaethuta881@gmail.com</a></li><br>
    ...
    <div class="vg-footer">
      <div class="container">
        <div class="row justify-content-center mt-3">
          <div class="col-12">
            <p class="text-center mb-0 mt-4">Copyright &copy;2022. All right reserved | This portfolio site is made with <span class="ti-heart fg-theme-red"></span> by <a href="https://www.facebook.com/pyae.thuta.881">PYAE THUTA</a></p>
          </div>
        </div>
      </div>
    </div> <!-- End footer -->
